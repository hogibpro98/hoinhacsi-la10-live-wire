                        ...
                        <div class="relative">
                            <form wire:submit.prevent="submit">
                                ...
                                <div class="flex flex-wrap flex-row -mx-4">
                                    <div
                                        class="flex-shrink max-w-full px-4 w-full">
                                        ...
                                        <div class="mb-6">
                                            <div class="flex">
                                                <div x-data="{dropdown_search: false}" class="w-full {{ $errors->has('partner_id') ? 'has-danger' : '' }}">
                                                    <button
        ...
        Livewire.on('showSuccessUpdated', () => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    Swal.close();
                    window.location.href = '{{ route('admin.top-partner') }}';
                }
            });
        });
