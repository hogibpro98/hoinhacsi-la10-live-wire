        ...
        <div class="flex flex-wrap flex-row">
            <div class="flex-shrink max-w-full w-full order-2 md:order-1 xl:w-2/3">
                <div class="flex flex-wrap flex-row">
                            ...
                            <div class="flex flex-row justify-between pb-6">
                                ...
                                <div x-data="{ open: false }" class="relative">
                                    <button @click="open = ! open"
                                            class="text-gray-500 hover:text-gray-600 transition-colors duration-200 focus:outline-none hover:outline-none">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                    ...
                                    <div x-show="open" @click.away="open = false"
                                         class="origin-top-right absolute ltr:right-0 rtl:left-0 rounded rounded-t-non bg-white z-10 border border-gray-200"
                                         style="min-width: 12rem; display: none;">
                                        <a class="block px-3 py-2 hover:bg-gray-100 focus:bg-gray-100"
                                           href="#">Daily</a>
                                        <a class="block px-3 py-2 hover:bg-gray-100 focus:bg-gray-100"
                                           href="#">Weekly</a>
                                        <a class="block px-3 py-2 hover:bg-gray-100 focus:bg-gray-100"
                    ...
                    <div class="flex-shrink max-w-full px-4 w-full lg:w-1/2 mb-6">
                        <div class="bg-white rounded-lg shadow-lg h-full p-6">
                            ...
                            <div class="relative w-full text-sm">
                                <a class="inline-block py-1.5 px-3 ltr:mr-2 rtl:ml-2 mb-3 border bg-gray-100 hover:bg-gray-200"
                                   href="#">Tailwind Css</a>
                                <a class="inline-block py-1.5 px-3 ltr:mr-2 rtl:ml-2 mb-3 border bg-gray-100 hover:bg-gray-200"
                                   href="#">Taildash</a>
                                <a class="inline-block py-1.5 px-3 ltr:mr-2 rtl:ml-2 mb-3 border bg-gray-100 hover:bg-gray-200"
                    ...
                    <div class="flex-shrink max-w-full px-4 w-full lg:w-1/2 mb-6">
                        <div class="bg-white rounded-lg shadow-lg h-full p-6">
                            ...
                            <div class="relative">
                                <a href="#">
                                    <img
                                        class="inline-block rounded-full shadow-xl w-12 h-12 max-w-full ltr:-mr-4 rtl:-ml-4 border-2 border-gray-200 bg-gray-300 transform hover:-translate-y-1"
                        ...
                        <div class="bg-white rounded-lg shadow-lg h-full p-6">
                            ...
                            <div class="relative text-sm">
                                <div class="inline-flex flex-row items-center mb-3 ltr:mr-2 rtl:ml-2">
                                    <div
                                        class="self-center py-1 px-2 rounded-full bg-transparent sm:bg-indigo-100 text-indigo-500 relative flex items-center justify-center">
                                        3.122
                                    </div>
                    ...
                    <div class="flex-shrink max-w-full px-4 w-full sm:w-1/2 mb-6">
                        <div class="bg-white rounded-lg h-full shadow-lg p-6">
                            <div class="flex flex-col pb-6">
            ...
            <div class="flex-shrink max-w-full px-4 w-full order-1 md:order-2 xl:w-1/3 mb-6">
                <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
                    ...
                    <div class="flex justify-between mb-3">
                        ...
                        <a href="#"
                           class="py-2 px-4 inline-block text-center mb-3 rounded leading-5 text-gray-100 bg-pink-500 border border-pink-500 hover:text-white hover:bg-pink-600 hover:ring-0 hover:border-pink-600 focus:bg-pink-600 focus:border-pink-600 focus:outline-none focus:ring-0">
                            ...
                            <span class="xl:hidden">Add</span> Pages
                        </a>
                    </div>
                    ...
                    <div class="hidden-header hidden-sort-after">
                        <!-- table posts -->
                        <table
                            class="table-sorter table-bordered-bottom w-full text-sm ltr:text-left rtl:text-right text-gray-500">
                            <thead>
                            ...
                            <tbody>
                            <tr>
                                <td><a href="#" target="_blank" class="hover:text-indigo-500 hover:underline">How to
                                        get started with Tailwind Css ?</a></td>
                                <td>934</td>
                                <td>136</td>
                                <td>121</td>
                            </tr>
                            <tr>
                                <td><a href="#" target="_blank" class="hover:text-indigo-500 hover:underline">Best
                                        Html admin template for Tailwind</a></td>
                                <td>789</td>
                                <td>132</td>
                                <td>98</td>
                            </tr>
                            ...
                            <tr>
                                <td><a href="#" target="_blank" class="hover:text-indigo-500 hover:underline">The
                                        Next Generation of Tailwind CSS</a></td>
                                <td>609</td>
                                <td>82</td>
                                <td>83</td>
                            </tr>
                            <tr>
                                <td><a href="#" target="_blank" class="hover:text-indigo-500 hover:underline">W3C
                                        TPAC 2021 Exhibition Space opens for registration</a></td>
                                <td>600</td>
                                <td>90</td>
                                <td>72</td>
                            </tr>
                            <tr>
                                <td><a href="#" target="_blank" class="hover:text-indigo-500 hover:underline">Minecraft
                                        Wild Update's Deep Cities Turn It Into A Horror Game</a></td>
                                <td>529</td>
                                <td>72</td>
                                <td>81</td>
                            </tr>
                            <tr>
                                <td><a href="#" target="_blank" class="hover:text-indigo-500 hover:underline">How
                                        Long Is A Day On Mars</a></td>
                                <td>509</td>
                                <td>62</td>
                                <td>77</td>
                            </tr>
                            <tr>
                                <td><a href="#" target="_blank" class="hover:text-indigo-500 hover:underline">Why
                                        The Moon Sequel Isn't Happening</a></td>
                                <td>500</td>
                                <td>52</td>
                                <td>57</td>
                            </tr>
                            <tr>
                                <td><a href="#" target="_blank" class="hover:text-indigo-500 hover:underline">How
                                        Far Away Is It From The Sun?</a></td>
                                <td>489</td>
                                <td>62</td>
                                <td>66</td>
                            </tr>
                            <tr>
                                <td><a href="#" target="_blank" class="hover:text-indigo-500 hover:underline">Mars
                                        is a cold planet filled with rocks & sand</a></td>
                                <td>489</td>
                                <td>62</td>
                                <td>57</td>
                            </tr>
                            <tr>
                                <td><a href="#" target="_blank" class="hover:text-indigo-500 hover:underline">Why
                                        Mars Has Longer Days Than Earth?</a></td>
                                <td>329</td>
                                <td>42</td>
                                <td>47</td>
                            </tr>
                            <tr>
                                <td><a href="#" target="_blank" class="hover:text-indigo-500 hover:underline">Mars
                                        Dunes Look Massive In This Stunning Perseverance Photo</a></td>
                                <td>249</td>
                                <td>32</td>
                                <td>34</td>
                            </tr>
